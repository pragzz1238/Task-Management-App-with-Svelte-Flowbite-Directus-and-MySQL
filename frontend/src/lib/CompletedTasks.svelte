<script>
  ...
  import TaskListCompletedTable from "./TaskListCompletedTable.svelte";
    let tasks = [];
    let loading = true;
    let isEditing = false;
    ...
    <div class="flex">
      ...
      <div class="flex-1 p-6">
        ...
        <div class="max-w-5xl mx-auto mt-16">
            ...
            <TaskListCompletedTable {tasks} handleDeleteTask={handleDeleteTask} handleEditTask={handleEditTask} />
        </div>
        {/if}
